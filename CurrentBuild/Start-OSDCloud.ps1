...
#Copy-Item "X:\OSDCloud\Config\Scripts\SetupComplete\Build-v2.ps1" "C:\OSDCloud\Scripts\Build-v2.ps1" -Force
...
powershell.exe -Command "& {IEX (IRM https://raw.githubusercontent.com/talbs101/intune/refs/heads/main/CurrentBuild/oobetasks-v2.ps1)}"
'@
